...
var cTotalFrames = 18;
var cFrameWidth = 128;
var cImageSrc = 'img/plugins/loading/sprites.gif';
...
function GameObject() {
	 ...
	 */
	this.startupGameObject = function(/** Number */
	x, /** Number */
	y, /** Number */
	z) {
		this.zOrder = z;
...
function VisualGameObject() {
	 ...
	 *            The depth
	 */
	this.startupVisualGameObject = function(/** Image */
	image, /** Number */
	x, /** Number */
	y, /** Number */
	z) {
...
function AnimatedGameObject() {
	 ...
	 */
	this.startupAnimatedGameObject = function(/** Image */
	image, /** Number */
	x, /** Number */
	y, /** Number */
	z, /** Number */
